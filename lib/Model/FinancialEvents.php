...
class FinancialEvents implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'shipmentEventList' => '\B1\AmazonSPAPI\Model\ShipmentEventList',
        'refundEventList' => '\B1\AmazonSPAPI\Model\ShipmentEventList',
        'guaranteeClaimEventList' => '\B1\AmazonSPAPI\Model\ShipmentEventList',
        'chargebackEventList' => '\B1\AmazonSPAPI\Model\ShipmentEventList',
        'payWithAmazonEventList' => '\B1\AmazonSPAPI\Model\PayWithAmazonEventList',
        'serviceProviderCreditEventList' => '\B1\AmazonSPAPI\Model\SolutionProviderCreditEventList',
        'retrochargeEventList' => '\B1\AmazonSPAPI\Model\RetrochargeEventList',
        'rentalTransactionEventList' => '\B1\AmazonSPAPI\Model\RentalTransactionEventList',
        'productAdsPaymentEventList' => '\B1\AmazonSPAPI\Model\ProductAdsPaymentEventList',
        'serviceFeeEventList' => '\B1\AmazonSPAPI\Model\ServiceFeeEventList',
        'sellerDealPaymentEventList' => '\B1\AmazonSPAPI\Model\SellerDealPaymentEventList',
        'debtRecoveryEventList' => '\B1\AmazonSPAPI\Model\DebtRecoveryEventList',
        'loanServicingEventList' => '\B1\AmazonSPAPI\Model\LoanServicingEventList',
        'adjustmentEventList' => '\B1\AmazonSPAPI\Model\AdjustmentEventList',
        'sAFETReimbursementEventList' => '\B1\AmazonSPAPI\Model\SAFETReimbursementEventList',
        'sellerReviewEnrollmentPaymentEventList' => '\B1\AmazonSPAPI\Model\SellerReviewEnrollmentPaymentEventList',
        'fBALiquidationEventList' => '\B1\AmazonSPAPI\Model\FBALiquidationEventList',
        'couponPaymentEventList' => '\B1\AmazonSPAPI\Model\CouponPaymentEventList',
        'imagingServicesFeeEventList' => '\B1\AmazonSPAPI\Model\ImagingServicesFeeEventList',
        'networkComminglingTransactionEventList' => '\B1\AmazonSPAPI\Model\NetworkComminglingTransactionEventList',
        'affordabilityExpenseEventList' => '\B1\AmazonSPAPI\Model\AffordabilityExpenseEventList',
        'affordabilityExpenseReversalEventList' => '\B1\AmazonSPAPI\Model\AffordabilityExpenseEventList',
        'trialShipmentEventList' => '\B1\AmazonSPAPI\Model\TrialShipmentEventList',
        'shipmentSettleEventList' => '\B1\AmazonSPAPI\Model\ShipmentSettleEventList',
        'taxWithholdingEventList' => '\B1\AmazonSPAPI\Model\TaxWithholdingEventList',
        'removalShipmentEventList' => '\B1\AmazonSPAPI\Model\RemovalShipmentEventList',
        'removalShipmentAdjustmentEventList' => '\B1\AmazonSPAPI\Model\RemovalShipmentAdjustmentEventList'
    ];
