 ...
 * @property Money $orderTotal
 * @property integer $numberOfItemsShipped
 * @property integer $numberOfItemsUnshipped
 * @property PaymentExecutionDetailItemList $paymentExecutionDetail
 * @property string $paymentMethod
 * @property PaymentMethodDetailItemList $paymentMethodDetails
 * @property string $marketplaceId
 * @property string $shipmentServiceLevelCategory
 * @property string $easyShipShipmentStatus
 ...
 * @property string $buyerInvoicePreference
 * @property string $promiseResponseDueDate
 * @property boolean $isBusinessOrder
 * @property boolean $isPrime
 * @property boolean $isPremiumOrder
 * @property boolean $isGlobalExpressEnabled
 * @property boolean $isReplacementOrder
 * @property boolean $isEstimatedShipDateSet
 * @property boolean $isSoldByAB
 * @property boolean $isISPU
 * @property Address $defaultShipFromLocationAddress
 * @property BuyerTaxInformation $buyerTaxInformation
 * @property FulfillmentInstruction $fulfillmentInstruction
 * @property MarketplaceTaxInfo $marketplaceTaxInfo
...
class Order  extends BaseModel implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'orderTotal' => '\B1\AmazonSPAPI\Model\Money',
        'numberOfItemsShipped' => 'int',
        'numberOfItemsUnshipped' => 'int',
        'paymentExecutionDetail' => '\B1\AmazonSPAPI\Model\PaymentExecutionDetailItemList',
        'paymentMethod' => 'string',
        'paymentMethodDetails' => '\B1\AmazonSPAPI\Model\PaymentMethodDetailItemList',
        ...
        'isSoldByAB' => 'bool',
        'defaultShipFromLocationAddress' => '\B1\AmazonSPAPI\Model\Address',
        'buyerInvoicePreference' => 'string',
        'buyerTaxInformation' => '\B1\AmazonSPAPI\Model\BuyerTaxInformation',
        'fulfillmentInstruction' => '\B1\AmazonSPAPI\Model\FulfillmentInstruction',
        'isISPU' => 'bool',
        'marketplaceTaxInfo' => '\B1\AmazonSPAPI\Model\MarketplaceTaxInfo',
        'sellerDisplayName' => 'string',
        'shippingAddress' => '\B1\AmazonSPAPI\Model\Address',
        'buyerInfo' => '\B1\AmazonSPAPI\Model\BuyerInfo',
        'automatedShippingSettings' => '\B1\AmazonSPAPI\Model\AutomatedShippingSettings'
    ];
     ...
     * Sets orderTotal
     *
     * @param \B1\AmazonSPAPI\Model\Money $orderTotal The total charge for this order.
     *
     * @return $this
     */
     ...
     *
     * @return \B1\AmazonSPAPI\Model\PaymentExecutionDetailItemList
     */
     ...
     *
     * @return \B1\AmazonSPAPI\Model\PaymentMethodDetailItemList
     */
     ...
     *
     * @param \B1\AmazonSPAPI\Model\PaymentMethodDetailItemList $paymentMethodDetails A list of payment methods for the order.
     *
     * @return $this
     */
     ...
     *
     * @param string $shipmentServiceLevelCategory The shipment service level category of the order.  Possible values: Expedited, FreeEconomy, NextDay, SameDay, SecondDay, Scheduled, Standard.
     *
     * @return $this
     */
     ...
     *
     * @param string $easyShipShipmentStatus The status of the Amazon Easy Ship order. This property is included only for Amazon Easy Ship orders.  Possible values: PendingPickUp, LabelCanceled, PickedUp, OutForDelivery, Damaged, Delivered, RejectedByBuyer, Undeliverable, ReturnedToSeller, ReturningToSeller.
     *
     * @return $this
     */
     ...
     *
     * @param string $earliestShipDate The start of the time period within which you have committed to ship the order. In ISO 8601 date time format. Returned only for seller-fulfilled orders.  Note: EarliestShipDate might not be returned for orders placed before February 1, 2013.
     *
     * @return $this
     */
     ...
     * Sets latestShipDate
     *
     * @param string $latestShipDate The end of the time period within which you have committed to ship the order. In ISO 8601 date time format. Returned only for seller-fulfilled orders.  Note: LatestShipDate might not be returned for orders placed before February 1, 2013.
     *
     * @return $this
     */
     ...
     *
     * @param \B1\AmazonSPAPI\Model\Address $defaultShipFromLocationAddress The recommended location for the seller to ship the items from. It is calculated at checkout. The seller may or may not choose to ship from this location.
     *
     * @return $this
     */
     ...
     *
     * @param string $buyerInvoicePreference The buyer’s invoicing preference.
     *
     * @return $this
     */
     ...
     *
     * @return \B1\AmazonSPAPI\Model\BuyerTaxInformation
     */
     ...
     *
     * @param \B1\AmazonSPAPI\Model\BuyerTaxInformation $buyerTaxInformation Contains the business invoice tax information.
     *
     * @return $this
     */
     ...
     *
     * @return \B1\AmazonSPAPI\Model\FulfillmentInstruction
     */
     ...
     *
     * @param \B1\AmazonSPAPI\Model\FulfillmentInstruction $fulfillmentInstruction Contains the instructions about the fulfillment like where should it be fulfilled from.
     *
     * @return $this
     */
     ...
     *
     * @return \B1\AmazonSPAPI\Model\MarketplaceTaxInfo
     */
     ...
     *
     * @param \B1\AmazonSPAPI\Model\MarketplaceTaxInfo $marketplaceTaxInfo Tax information about the marketplace.
     *
     * @return $this
     */
     ...
     *
     * @param \B1\AmazonSPAPI\Model\Address $shippingAddress shippingAddress
     *
     * @return $this
     */
     ...
     * Gets buyerInfo
     *
     * @return \B1\AmazonSPAPI\Model\BuyerInfo
     */
     ...
     * Sets buyerInfo
     *
     * @param \B1\AmazonSPAPI\Model\BuyerInfo $buyerInfo buyerInfo
     *
     * @return $this
     */
     ...
     *
     * @return \B1\AmazonSPAPI\Model\AutomatedShippingSettings
     */
     ...
     *
     * @param \B1\AmazonSPAPI\Model\AutomatedShippingSettings $automatedShippingSettings Contains information regarding the Shipping Settings Automaton program, such as whether the order's shipping settings were generated automatically, and what those settings are.
     *
     * @return $this
     */
