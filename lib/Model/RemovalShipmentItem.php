 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RemovalShipmentItem  extends BaseModel implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'quantity' => 'int',
        'revenue' => '\B1\AmazonSPAPI\Model\Currency',
        'feeAmount' => '\B1\AmazonSPAPI\Model\Currency',
        'taxAmount' => '\B1\AmazonSPAPI\Model\Currency',
        'taxWithheld' => '\B1\AmazonSPAPI\Model\Currency'
    ];
     ...
     * Sets revenue
     *
     * @param \B1\AmazonSPAPI\Model\Currency $revenue The total amount paid to the seller for the removed item.
     *
     * @return $this
     */
     ...
     * Sets feeAmount
     *
     * @param \B1\AmazonSPAPI\Model\Currency $feeAmount The fee that Amazon charged to the seller for the removal of the item. The amount is a negative number.
     *
     * @return $this
     */
     ...
     * Sets taxAmount
     *
     * @param \B1\AmazonSPAPI\Model\Currency $taxAmount Tax collected on the revenue.
     *
     * @return $this
     */
     ...
     * Sets taxWithheld
     *
     * @param \B1\AmazonSPAPI\Model\Currency $taxWithheld The tax withheld and remitted to the taxing authority by Amazon on behalf of the seller. If TaxCollectionModel=MarketplaceFacilitator, then TaxWithheld=TaxAmount (except the TaxWithheld amount is a negative number). Otherwise TaxWithheld=0.
     *
     * @return $this
     */
