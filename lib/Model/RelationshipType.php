 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class RelationshipType  extends BaseModel implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'identifiers' => '\B1\AmazonSPAPI\Model\IdentifierType',
        'color' => 'string',
        'edition' => 'string',
        'flavor' => 'string',
        'gemType' => 'string[]',
     ...
     * Gets identifiers
     *
     * @return \B1\AmazonSPAPI\Model\IdentifierType
     */
     ...
     * Sets identifiers
     *
     * @param \B1\AmazonSPAPI\Model\IdentifierType $identifiers The identifiers that uniquely identify the item that is related.
     *
     * @return $this
     */
     ...
     * Sets golfClubLoft
     *
     * @param \B1\AmazonSPAPI\Model\DecimalWithUnits $golfClubLoft The golf club loft variation of an item.
     *
     * @return $this
     */
     ...
     *
     * @param \B1\AmazonSPAPI\Model\DecimalWithUnits $totalDiamondWeight The total diamond weight variation of an item.
     *
     * @return $this
     */
     ...
     * Sets totalGemWeight
     *
     * @param \B1\AmazonSPAPI\Model\DecimalWithUnits $totalGemWeight The total gem weight variation of an item.
     *
     * @return $this
     */
     ...
     * Sets itemDimensions
     *
     * @param \B1\AmazonSPAPI\Model\DimensionType $itemDimensions The item dimensions relationship of an item.
     *
     * @return $this
     */
