 ...
 *
 *
 * @property string[] $marketplaceIds
 * @property string $reportId
 * @property string $reportType
 * @property string $reportDocumentId
 * @property string $dataStartTime
 * @property string $dataEndTime
 * @property string $reportScheduleId
 * @property string $createdTime
 * @property string $processingStatus
 * @property string $processingEndTime
 */
class Report  extends BaseModel implements ModelInterface, ArrayAccess
{
