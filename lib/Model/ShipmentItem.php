...
class ShipmentItem implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'itemChargeAdjustmentList' => '\B1\AmazonSPAPI\Model\ChargeComponentList',
        'itemFeeList' => '\B1\AmazonSPAPI\Model\FeeComponentList',
        'itemFeeAdjustmentList' => '\B1\AmazonSPAPI\Model\FeeComponentList',
        'itemTaxWithheldList' => '\B1\AmazonSPAPI\Model\TaxWithheldComponentList',
        'promotionList' => '\B1\AmazonSPAPI\Model\PromotionList',
        'promotionAdjustmentList' => '\B1\AmazonSPAPI\Model\PromotionList',
     ...
     * Sets itemChargeList
     *
     * @param \B1\AmazonSPAPI\Model\ChargeComponentList $itemChargeList A list of charges associated with the shipment item.
     *
     * @return $this
     */
     ...
     *
     * @param \B1\AmazonSPAPI\Model\ChargeComponentList $itemChargeAdjustmentList A list of charge adjustments associated with the shipment item. This value is only returned for refunds, guarantee claims, and chargeback events.
     *
     * @return $this
     */
     ...
     * Sets itemFeeList
     *
     * @param \B1\AmazonSPAPI\Model\FeeComponentList $itemFeeList A list of fees associated with the shipment item.
     *
     * @return $this
     */
     ...
     *
     * @param \B1\AmazonSPAPI\Model\FeeComponentList $itemFeeAdjustmentList A list of fee adjustments associated with the shipment item. This value is only returned for refunds, guarantee claims, and chargeback events.
     *
     * @return $this
     */
     ...
     *
     * @param \B1\AmazonSPAPI\Model\TaxWithheldComponentList $itemTaxWithheldList A list of taxes withheld information for a shipment item.
     *
     * @return $this
     */
     ...
     * Gets promotionList
     *
     * @return \B1\AmazonSPAPI\Model\PromotionList
     */
     ...
     * Sets promotionList
     *
     * @param \B1\AmazonSPAPI\Model\PromotionList $promotionList promotionList
     *
     * @return $this
     */
     ...
     *
     * @param \B1\AmazonSPAPI\Model\PromotionList $promotionAdjustmentList A list of promotion adjustments associated with the shipment item. This value is only returned for refunds, guarantee claims, and chargeback events.
     *
     * @return $this
     */
