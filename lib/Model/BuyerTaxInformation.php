...
/**
 * @property string $buyerLegalCompanyName
 * @property string $buyerBusinessAddress
 * @property string $buyerTaxRegistrationId
 * @property string $buyerTaxOffice
 */
class BuyerTaxInformation extends BaseModel implements ModelInterface, ArrayAccess
{
