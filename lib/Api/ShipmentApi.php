...
class ShipmentApi
{
     ...
     * @param  \B1\AmazonSPAPI\Model\UpdateShipmentStatusRequest $payload Request to update the shipment status. (required)
     *
            ...
            switch ($e->getCode()) {
                case 400:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\B1\AmazonSPAPI\Model\UpdateShipmentStatusErrorResponse',
     ...
     */
    protected function updateShipmentStatusRequest($orderId, $payload)
    {
