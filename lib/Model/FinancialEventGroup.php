...
class FinancialEventGroup implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'fundTransferDate' => '\B1\AmazonSPAPI\Model\\DateTime',
        'traceId' => 'string',
        'accountTail' => 'string',
        'beginningBalance' => '\B1\AmazonSPAPI\Model\Currency',
        'financialEventGroupStart' => '\B1\AmazonSPAPI\Model\\DateTime',
        'financialEventGroupEnd' => '\B1\AmazonSPAPI\Model\\DateTime'
    ];
